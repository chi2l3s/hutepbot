...
from ...models.get_panel_api_clients_links_email_response_200 import GetPanelApiClientsLinksEmailResponse200
...
def _parse_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
    ...
    if response.status_code == 200:
        response_200 = GetPanelApiClientsLinksEmailResponse200.from_dict(response.json())
