...
from ...models.post_panel_api_server_import_db_response_200 import PostPanelApiServerImportDBResponse200
...
def sync_detailed(
    *,
    ...
    r"""Restore the panel DB from an uploaded SQLite file (multipart form, field name \"db\"). The panel
