...
) -> GetPanelApiServerGetPanelUpdateInfoResponse200 | None:
    if response.status_code == 200:
        response_200 = GetPanelApiServerGetPanelUpdateInfoResponse200.from_dict(response.json())
...
def _build_response(
    *, client: AuthenticatedClient | Client, response: httpx.Response
) -> Response[GetPanelApiServerGetPanelUpdateInfoResponse200]:
    return Response(
